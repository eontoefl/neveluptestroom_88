...
function renderLectureSetResult(resultData) {
    ...
    const audioId = 'lecture-main-audio';
        ...
        <div class="conver-result-item ${statusClass}">
            <div class="question-header">
                <div class="question-number">
                    ...
                    <span>문제 ${index + 1} - ${statusText}</span>
                </div>
            </div>
            ...
            <div class="answer-summary">
                <div class="answer-item ${isCorrect ? 'correct' : 'wrong'}">
                    <strong>내 답변:</strong> <span>${userAnswerText}</span>
                </div>
                <div class="answer-item correct">
                    <strong>정답:</strong> <span>${correctAnswerText}</span>
                </div>
            </div>
        ...
        return `
            <div class="option-detail">
                ...
                <div class="option-body">
                    ${translation ? `<p><strong>번역:</strong> ${translation}</p>` : ''}
                    ${explanation ? `<p><strong>해설:</strong> ${explanation}</p>` : ''}
                </div>
            </div>
        `;
    }).join('');
...
console.log('✅ listening-lecture-logic-fixed.js 로드 완료');
